<?php
/* Google Maps API - Multiple Equipments
============================== */
function tw_google_maps_api_multiple_equipments() {

// Check For Property Search Template
global $realty_theme_option;
if ( is_page_template( 'template-equipments-search.php') || is_page_template( 'template-map-vertical.php' ) ) {
...
if ( $google_maps ) {
	...
	if($realty_theme_option['price-thousands-separator']=="'") {
		...
		echo "pppp".$realty_theme_option['price-thousands-separator'];
	}
	else {
		$property_string .= "price:'" . tt_property_price() . "', ";
	}
...
add_action( 'wp_footer', 'tw_google_maps_api_multiple_equipments', 20 );
?>
