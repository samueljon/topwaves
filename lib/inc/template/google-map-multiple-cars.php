<?php
/* Google Maps API - Multiple cars
============================== */
function tw_google_maps_api_multiple_cars() {

// Check For Property Search Template
global $realty_theme_option;
if ( is_page_template( 'template-cars-search.php') || is_page_template( 'template-map-vertical.php' ) ) {
...
add_action( 'wp_footer', 'tw_google_maps_api_multiple_cars', 20 );
?>
